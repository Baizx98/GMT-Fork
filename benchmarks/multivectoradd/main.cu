...
__global__ //__launch_bounds__(64,32)
    void
    kernel_baseline(uint64_t n_elems, TYPE *A, TYPE *B, TYPE *sum)
{
...
__global__ //__launch_bounds__(64,32)
    void
    kernel_sequential_warp_ptr_pc(array_d_t<T> *da, array_d_t<T> *db, uint64_t n_elems, uint64_t n_pages_per_warp, array_d_t<T> *dc, TYPE *sum, uint64_t n_warps, size_t page_size, uint64_t stride)
{
...
__global__ //__launch_bounds__(64,32)
    void
    kernel_sequential_warp_ptr_pc(array_d_t<T> *d_in, array_d_t<T> *d_out, uint64_t n_elems, uint64_t n_pages_per_warp, uint64_t n_warps, size_t page_size, uint64_t stride)
{
