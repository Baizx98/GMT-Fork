...
void Settings::parseArguments(int argc, char **argv)
{
    OptionMap parsers = {
        ...
        {'i', OptionPtr(new Option<uint64_t>(iter, "number", "iter", "number of itertations", "5"))},
...
Settings::Settings()
{
    ...
    stats = false;
    input = nullptr;
    input_a = "/export/home3/cuc1057/allA";
    input_b = "/export/home3/cuc1057/allB";
    output = nullptr;
    afileoffset = 0;
    bfileoffset = 0;
    // type = 1;
    // memalloc = 2;
    type = 2; // BASELINE_PC:2, OPTIMIZED_PC:3
    memalloc = 6;
    ...
    iter = 5;
    n_elems = 21474836480;
    n_elems = (uint64_t)3579142144; // ~26.667 GB
    // n_elems = 128 * 1024;

    // maxPageCacheSize = numBase * numBase * numBase * 8;
    // n_elems = 8192;
}
