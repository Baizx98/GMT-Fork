...
#pragma omp parallel for reduction(+ : virt_dist_sum, reuse_dist_sum, reuse_dist_square_sum, virt_reuse_dist_product_sum)
        ...
        slope = (((double)num_samples * (double)virt_reuse_dist_product_sum - (double)reuse_dist_sum * (double)virt_dist_sum) / ((double)num_samples * (double)reuse_dist_square_sum - (double)reuse_dist_sum * (double)reuse_dist_sum));
