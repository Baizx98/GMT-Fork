 ...
 */
__device__ __host__ static inline void nvm_cmd_header(nvm_cmd_t *cmd, uint16_t cid, uint8_t opcode, uint32_t ns_id)
{
 ...
 */
__device__ __host__ static inline void nvm_cmd_data_ptr(nvm_cmd_t *cmd, uint64_t prp1, uint64_t prp2)
{
 ...
 */
__device__ __host__ static inline void nvm_cmd_rw_blks(nvm_cmd_t *cmd, uint64_t start_lba, uint16_t n_blks)
{
 ...
 */
__host__ __device__ static inline size_t nvm_prp_list(const nvm_prp_list_t *list, size_t n_pages, const uint64_t *ioaddrs)
{
 ...
 */
__host__ __device__ static inline size_t nvm_prp_list_chain(size_t n_lists, const nvm_prp_list_t *lists, size_t n_pages, const uint64_t *ioaddrs)
{
    size_t i_list;
    size_t list_prps;
    size_t n_prps;
 ...
 */
__host__ __device__ static inline size_t nvm_cmd_data(nvm_cmd_t *cmd, size_t n_lists, const nvm_prp_list_t *lists, size_t n_pages, const uint64_t *ioaddrs)
{
    size_t prp = 0;
    uint64_t dptr0 = 0;
    uint64_t dptr1 = 0;
